...
import { FaChartPie, FaUtensils, FaUsers, FaStar, FaBars, FaTimes } from 'react-icons/fa';
...
const  Dashboard = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gray-100 text-gray-800 font-sans relative">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-40 h-full w-64 bg-white shadow-md p-5 space-y-6 transform transition-transform duration-300 ${
          sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        } lg:translate-x-0 lg:static lg:flex`}
      >
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-bold text-green-600">🍔 FoodKing</h1>
          <button
