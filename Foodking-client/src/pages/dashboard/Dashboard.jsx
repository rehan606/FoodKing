...
import { FaChartPie, FaUtensils, FaUsers, FaStar, FaPlusCircle, FaShoppingCart } from 'react-icons/fa';
...
const Dashboard = () => {
  return (
    <div className="min-h-screen flex bg-gray-100 text-gray-800 font-sans">
      {/* Sidebar */}
      <aside className="w-64 bg-white shadow-md hidden lg:flex flex-col p-5 space-y-6">
