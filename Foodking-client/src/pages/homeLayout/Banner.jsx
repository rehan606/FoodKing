        ...
        <section className="  addfoodbg ">
            <div className="w-11/12 mx-auto flex flex-col md:flex-row items-center justify-between gap-6 py-20">
                ...
                <div className="md:w-1/2 text-center md:text-left ">
                    <p className="text-sm text-[#D12525] font-semibold">Delicious & Fresh</p>
                    ...
                    <Link to='/allFoods' className="mt-6 px-6 py-3  bg-green-600 text-white font-semibold rounded-lg hover:bg-teal-600 transition">
                    View All Foods
                    </Link>
                </div>
