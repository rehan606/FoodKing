      ...
      <section className="bg-[#F3F4F6] text-gray-300 py-20 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8  p-6 rounded-lg">
            {/* Service 1 */}
            <div className="bg-white p-6 rounded-lg shadow-lg text-left border border-gray-100 hover:shadow-xl hover:shadow-green-600">
              <div className="text-green-500 text-4xl mb-4">
              <GiOpenedFoodCan />
              </div>
              <h3 className="text-xl font-semibold mb-2 text-gray-600">Super quality food</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-left border border-gray-100 hover:shadow-xl hover:shadow-green-600">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-600">Original recipes</h3>
              <p className="text-gray-400">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-left border border-gray-100 hover:shadow-xl hover:shadow-green-600">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-600">Quick fast delivery</h3>
              <p className="text-gray-400">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-left border border-gray-100 hover:shadow-xl hover:shadow-green-600 ">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-600">100% fresh foods</h3>
              <p className="text-gray-400">
